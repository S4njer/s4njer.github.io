---
layout: post
title: 'Uso y configuración Tmux & VIM'
date: 2023-02-14
categories: [Tmux, pers.Tmux, vim]
img_path: /assets/images/
img: vim-and-tmux-1-638-1382055558.png
---

![vim-tmux](vim-and-tmux-1-638-1382055558.png)
...
>  Para poder mover, cortar, etc.. más de una línea, palabra símplemente debemos en modo comando introducir la cantidad que queremos seguido del comando: *Ej:* 10000dd (esto cortará 10000 líneas)
{: .prompt-tip }
